...
<cfelse>
	...
	<div style="font-size:16px; font-weight:normal; text-transform:uppercase; color:##555;"><cfif ActivityBean.getParentActivityID() NEQ ""><cfif Len(ParentBean.getTitle()) GT 75><span title="#ParentBean.getTitle()#">#left(ParentBean.getTitle(),50) & "..."#</span><cfelse>#ParentBean.getTitle()#</cfif> <cfelse>Parent Activity</cfif> // <cfif ParentBean.getSessionType() EQ "M">Multi-Session<cfelse>Single-Session</cfif></div>
	...
	<table cellspacing="0" border="0" cellpadding="0" class="MultiForm" width="960">
		<tbody>
			<tr>
