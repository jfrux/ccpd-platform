      ...
      <div class="navbar navbar-fixed navbar-inverse">
          <div class="navbar-inner">
            <div class="container-fluid">
              ...
              <a class="brand" href="##" name="top">CCPD</a>
              <div class="nav-collapse collapse">
                <ul class="nav">
                  <li><a href="#myself#main.welcome"><i class="icon-home icon-white"></i> News Feed</a></li>
                  <li><a href="#myself#activity.home"><i class="icon-file icon-white"></i> Activities</a></li>
                  <li><a href="#myself#person.home"><i class="icon-envelope icon-white"></i> People</a></li>
                  <li><a href="#myself#report.home"><i class="icon-signal icon-white"></i> Reports</a></li>
                  <li class="divider-vertical"></li>
                  <li><a href="#myself#person.detail?personid=#session.person.getPersonId()#">#session.person.getdisplayname()#</a></li>
                  <li><a href="#myself#Main.doLogout">Logout</a></li>
                </ul>
