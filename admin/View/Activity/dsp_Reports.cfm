	...
	<div class="report-group">
		...
		<div class="report-item">
			...
			<div class="report-item-criteria">
				...
				<select name="AssessmentID" id="AssessmentID" class="fieldinput" style="width: 190px;">
					...
					<div><input type="checkbox" name="showDeleted" id="showDeleted-1" checked="checked" /> <label for="showDeleted-1">Show deleted questions in report.</label></div>
		...
		<div class="report-item">
			...
			<div class="report-item-criteria">
				...
				<div><input type="checkbox" name="showDeleted" id="showDeleted-2" checked="checked" /> <label for="showDeleted-2">Show deleted questions in report.</label></div>
				<input type="submit" name="submit" value="Download" class="button" />
				</form>
			</div>
		</div>
		<div class="report-item">
			...
			<div class="report-item-criteria">
				...
				<div><input type="checkbox" name="showDeleted" id="showDeleted-3" checked="checked" /> <label for="showDeleted-3">Show deleted questions in report.</label></div>
				<input type="submit" name="submit" value="Download" class="button" />
				</form>
			</div>
		</div>
