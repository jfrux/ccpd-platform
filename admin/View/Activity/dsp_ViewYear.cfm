...
<cfoutput>
	<p id="calendarcontrols">
		&laquo;
		<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Year&Date=#Fix( dtPrevYear )#">#DateFormat( dtPrevYear, "yyyy" )#</a> &nbsp;|&nbsp;
		<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Year&Date=#Fix( dtNextYear )#">#DateFormat( dtNextYear, "yyyy" )#</a>
		&raquo;
	</p>
