...
FROM         ce_Person_Address AS addr LEFT OUTER JOIN
                      geonameCities AS geo ON addr.City = geo.name INNER JOIN
                      geoname_admin1CodesASCII AS adm1 ON geo.country_code + '.' + geo.admin1_code = adm1.code
