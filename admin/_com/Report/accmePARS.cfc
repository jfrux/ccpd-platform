<cfcomponent displayname="ACCME Summary Report" output="no">
  ...
  <cfset ReportFileName = "accmePARS-#DateFormat(Now(),'MMDDYY')##TimeFormat(Now(),'hhmmss')#-#Session.AccountID#.xlsx">
  <cfset ColumnCount = 3>
    ...
    <cfif Status EQ "">
      ...
      <cfloop query="qACCMEData">  
        ...
        <cfscript>
          ...
          //SPECIAL CIRCUMSTANCES FOR ACCME
          if(qACCMEData.Country EQ "PRI") {
            querySetCell(qReport,"City",qACCMEData.City);
            querySetCell(qReport,"State","PR");
            querySetCell(qReport,"Country","USA");
          } else {
            querySetCell(qReport,"City",qACCMEData.City);
            ...
            <poi:sheet name="#BookName#" orientation="landscape">
              ...
              <poi:row class="row">
                ...
                <cfif qReport.TotalExpenses>
                  <poi:cell value="#(qReport.TotalExpenses * -1)#" type="numeric" numberformat="0.00" />
                <cfelse>
                  <poi:cell value="" />
                </cfif>
