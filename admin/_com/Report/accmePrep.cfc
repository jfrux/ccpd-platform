<cfcomponent displayname="ACCME Preparation" output="no">
	...
	<cffunction name="Run" access="remote" output="yes">
		...
		<cfif Status EQ "">
			<cfset qACCMEData = createObject("component","admin._com.Report.accmePARS").getACCMEData(startDate=arguments.startDate,endDate=arguments.endDate,requireCredit=false) />
