...
<cfdocument format="PDF" saveAsName="Transcript_#Session.PersonID#_#DateFormat(Now(), 'mmddyyyy')#">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
            <td><img src="/lms/_images/uc_logo_50percent.png"></td>
            <td align="center" style="color: ##006;">
                <h3>Center for Continuous Professional Development, CME, CNE, CPE</h3><br>
                <h1><em>Continuing Education Transcript</em></h1>
            </td>
            <td></td>
        </tr>
        <tr>
                    	...
                    	<td>
                        	<table>
                            	<tr>
                                    ...
                                    <td><cfif session.person.getCertName() NEQ "">#session.person.getCertName()#<cfelse>#session.person.getFirstName()# #session.person.getLastName()#</cfif></td>
                                </tr>
                                <tr>
        ...
        <tr>
            <td colspan="3">This transcript reflects our records for your attendance at UC sponsored activities.  If you believe that this transcript is incomplete or incorrect please contact our office: (513) 558-7399.</td>
        </tr>
    </table>
    </cfoutput>
    </div>
