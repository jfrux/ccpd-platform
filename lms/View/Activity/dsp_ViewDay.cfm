...
<cfoutput>
	...
	<p id="calendarcontrols">
		&laquo;
		<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Day&Date=#Fix( dtPrevDay )#">#DateFormat( dtPrevDay, "mmmm d, yyyy" )#</a> &nbsp;|&nbsp;
		<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Day&Date=#Fix( dtNextDay )#">#DateFormat( dtNextDay, "mmmm d, yyyy" )#</a>
		&raquo;
	</p>
	...
	<tr class="days">
		...
		<td 
			...
			<a 
				href="#myself#Activity.Event&ActivityID=#Attributes.ActivityID#&ViewAs=#dtDay#" 
			...
			<cfif StructKeyExists( objEvents.Index, dtDay )>
				...
				<cfloop query="qEventSub">
					...
					<a 
						href="#myself#Activity.Event&ActivityID=#Attributes.ActivityID#&id=#qEventSub.id#&ViewAs=#dtDay#"
