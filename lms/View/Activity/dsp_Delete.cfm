<cfparam name="Request.Attributes.id" default="#attributes.id#">
<cfparam name="Request.Attributes.viewas" default="#attributes.viewas#">
<!--- Kill extra output. --->
<cfsilent>
	...
	<cfif NOT qEvent.RecordCount>
		...
		<cflocation 
			url="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=month&date=#REQUEST.Attributes.viewas#"
			addtoken="false"
			/>
	...
	<cfif FORM.submitted>
		...
		<cfif NOT ArrayLen( arrErrors )>
			...
			<cfelse>
				...
				<cflocation
					url="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Month&date=#Fix( qEvent.date_started )#"
					addtoken="false"
					/>
...
<cfoutput>
	...
	<form action="#myself#Activity.DeleteEvent&ActivityID=#Attributes.ActivityID#&id=#Attributes.Id#&viewas=#Attributes.viewas#" method="post">
