...
<cfoutput>
	<p id="calendarcontrols">
		&laquo;
		<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Week&Date=#Fix( dtPrevWeek )#">#DateFormat( dtPrevWeek, "mmmm d, yyyy" )#</a> &nbsp;|&nbsp;
		<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Week&Date=#Fix( dtNextWeek )#">#DateFormat( dtNextWeek, "mmmm d, yyyy" )#</a>
		&raquo;
	</p>
	...
	<cfloop 
		...
		<cfif ((DayOfWeek( dtDay ) MOD 7) EQ 1)>
			<tr class="days">
				<td class="header">
					<a href="#myself#Activity.Calendar&ActivityID=#Attributes.ActivityID#&Mode=Month&Date=#dtDay#">&raquo;</a>
				</td>
		</cfif>
