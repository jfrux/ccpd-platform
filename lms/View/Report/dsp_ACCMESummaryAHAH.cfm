...
<table id="GeneratedReports" class="ViewSectionGrid" cellspacing="0" width="100%">
	...
	<cfdirectory directory="#ExpandPath('#Application.Settings.RootPath#/_reports/11')#" action="list" name="qFileList" filter="*-#Session.AccountID#.XLS" recurse="no">
	...
	<cfloop query="qOrderedFileList">
		<tr>
			<td><a href="#Application.Settings.RootPath#/_reports/11/#qOrderedFileList.Name#" target="_blank">#qOrderedFileList.Name#</a></td>
