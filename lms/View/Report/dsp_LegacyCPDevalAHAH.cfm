...
<cfdirectory directory="#ExpandPath('#Application.Settings.RootPath#/_reports/23')#" action="list" name="qFileList" filter="*-#Session.AccountID#.XLS" recurse="no">
<cfoutput>
...
<div class="notify"><a href="#Application.Settings.RootPath#/_reports/23/#qMostRecent.Name#" target="_blank">#qMostRecent.Name# Download Now!</a></div>
...
<table id="GeneratedReports" class="ViewSectionGrid" cellspacing="0" width="100%">
	...
	<cfloop query="qOrderedFileList">
		<tr>
			<td><a href="#Application.Settings.RootPath#/_reports/23/#qOrderedFileList.Name#" target="_blank">#qOrderedFileList.Name#</a></td>
