<cfcomponent displayname="Verity Index">
		...
		<!---<cfloop query="qIndex">
			...
			<cfquery name="qAttendees" datasource="#Application.Settings.DSN#">
				...
				FROM         ce_Attendee AS ac LEFT OUTER JOIN
				  dbo.pd_person AS p1 ON p1.personid = ac.PersonID
	...
	<cffunction name="Search" access="remote" output="yes">
		...
		<cfset SearchPager.setBaseLink("#Application.Settings.RootPath#/_com/VerityIndex.cfc?method=Search&q=#Arguments.q#") />
		...
		<cfset SearchPager.setClassName("green") />
			...
			<cfif isDefined("ResultStatus.SuggestedQuery")>Did you mean <a href="#Application.Settings.RootPath#/_com/VerityIndex.cfc?method=Search&q=#ResultStatus.suggestedQuery#" id="DidYouMean">#ResultStatus.suggestedQuery#</a>?</cfif>
