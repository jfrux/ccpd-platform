	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		...
		<cfquery name="qCreate" datasource="#variables.dsn#" result="CreateResult">
				...
				VALUES
					...
					<cfqueryparam value="#arguments.Person.getPrimary_Photo()#" CFSQLType="cf_sql_varchar" null="#not len(arguments.Person.getPrimary_Photo())#" />,
	...
	<cffunction name="update" access="public" output="false" returntype="boolean">
		...
		<cfquery name="qUpdate" datasource="#variables.dsn#">
				...
				SET
					...
					Primary_Photo = <cfqueryparam value="#arguments.Person.getPrimary_Photo()#" CFSQLType="cf_sql_varchar" null="#not len(arguments.Person.getPrimary_Photo())#" />,
