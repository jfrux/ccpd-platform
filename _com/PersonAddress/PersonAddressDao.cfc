	...
	<cffunction name="create" access="public" output="false" returntype="boolean">
		...
		<cfquery name="qCreate" datasource="#variables.dsn#" result="CreateResult">
				...
				VALUES
					...
					<cfqueryparam value="#arguments.PersonAddress.getStateId()#" CFSQLType="cf_sql_integer" null="#not arguments.PersonAddress.getStateId() GT 0#" />,
					...
					<cfqueryparam value="#arguments.PersonAddress.getCountryId()#" CFSQLType="cf_sql_integer" null="#not arguments.PersonAddress.getCountryId() GT 0#" />,
	...
	<cffunction name="update" access="public" output="false" returntype="boolean">
		...
		<cfquery name="qUpdate" datasource="#variables.dsn#">
				...
				SET
					...
					StateId = <cfqueryparam value="#arguments.PersonAddress.getStateId()#" CFSQLType="cf_sql_integer" null="#not arguments.PersonAddress.getStateId() GT 0#" />,
					...
					CountryId = <cfqueryparam value="#arguments.PersonAddress.getCountryId()#" CFSQLType="cf_sql_integer" null="#not arguments.PersonAddress.getCountryId() GT 0#" />,
