<cfcomponent displayname="Person">
  ...
  <cffunction name="saveAddress" access="public" output="false" returntype="struct">
    ...
    <cfset PersonAddressBean.setCountryId(Arguments.Countryid)>
  ...
  <cffunction name="setPrimaryAddress" access="public" output="false" returntype="struct">
    ...
    <cfset status.setStatus(false)>
    <cfset status.setStatusMsg("You do not have permission to modify the primary address.")>
    ...
    <cfset personBean.setPrimaryAddressID(arguments.address_id) />
    ...
    <cfif personSaved>
      <cfset status.setStatus(true)>
      <cfset status.setStatusMsg("Primary address has been updated.")>
    </cfif>
    <cfreturn status />
  </cffunction>
