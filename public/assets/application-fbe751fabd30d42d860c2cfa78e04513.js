  ...
  App.module("Activity", {
    ...
    define: function(Self, App, Backbone, Marionette, $) {
      ...
      continueCopy = function() {
        var nCopyChoice, nError, nNewActivityType, nNewGrouping, sNewActivityTitle;
...
(function() {
  ...
  App.Models.Activity = (function(_super) {
    __extends(Activity, _super);

    function Activity(defaults) {
...
(function() {
  App.module("Activity.Participants", function(Self, App, Backbone, Marionette, $) {
    var addSelectedAttendee, addlAttendeesUnsaved, cancelButton, checkmarkMember, clearSelectedMembers, getSelectedAttendees, getSelectedMembers, removeSelectedPerson, resetAttendee, saveAttendee, selectedAttendees, selectedCount, selectedMembers, setAddlPartic, updateRegistrants, updateSelectedCount, updateStatusDate, _init;
    ...
    App.on("activity.participants.load", function() {
      App.logInfo("participants_page_loaded");
      return App.trigger("activity.participants.ahahload");
    });
    App.on("activity.participants.ahahload", function() {
      return App.logInfo("participants_ahah_loaded");
    });
    getSelectedAttendees = function() {
      return selectedAttendees.split(',');
    };
    getSelectedMembers = function() {
      return selectedMembers.split(',');
    };
    clearSelectedMembers = function() {
      selectedAttendees = "";
      selectedMembers = "";
      selectedCount = 0;
      $("#CheckedCount").html("0");
    ...
    updateSelectedCount = function(nAmount) {
      App.logInfo("Count is currently " + parseInt(selectedCount));
      App.logInfo("Updating Count by " + parseInt(nAmount));
      selectedCount = parseInt(selectedCount) + parseInt(nAmount);
      if (selectedCount < 0) {
    ...
    addSelectedAttendee = function(params) {
      var settings;

      settings = $.extend({}, params);
      if (!(settings.person && settings.person > 0 ? $.ListFind(selectedMembers, settings.person, ",") : void 0)) {
        selectedMembers = $.ListAppend(selectedMembers, settings.person, ",");
      }
      if (!(settings.attendee && settings.attendee > 0 ? $.ListFind(selectedAttendees, settings.attendee, ",") : void 0)) {
        selectedAttendees = $.ListAppend(selectedAttendees, settings.attendee, ",");
      }
      updateSelectedCount(1);
    };
    removeSelectedPerson = function(params) {
      var settings;
    ...
    saveAttendee = Self.saveAttendee = function() {
      $.blockUI({
    ...
    checkmarkMember = function(params) {
      if (settings.attendee && settings.attendee > 0) {
        if ($.ListFind(selectedAttendees, settings.attendee, ",")) {
          $("#Checked-" + settings.attendee).attr("checked", true);
          return $("#attendeeRow-" + settings.attendee).css("background-color", "#FFD");
        }
      }
    };
    updateRegistrants = function(nPage, nStatus) {
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          return $(".AllAttendees").each(function() {
            var $checkBox, $row, nAttendee, nPerson;
            ...
            return $checkBox.click(function() {
              if ($(this).attr("checked")) {
                ...
                return addSelectedAttendee({
                  person: nPerson,
                  attendee: nAttendee
                });
              } else {
                $("#attendeeRow-" + nAttendee).css("background-color", "#FFF");
                return removeSelectedPerson({
                  person: nPerson,
                  attendee: nAttendee
                });
              }
    ...
    Self.bind = function() {
      ...
      $("#CheckAll").click(function() {
        if ($("#CheckAll").attr("checked")) {
          return $(".AllAttendees").each(function() {
            ...
            return $row.css("background-color", "#FFD");
          });
        } else {
          return $(".AllAttendees").each(function() {
            var $checkBox, $row, nAttendee, nPerson;
            ...
            return $row.css("background-color", "#FFF");
          });
        }
      });
      ...
      $("#PersonDetail").dialog({
        ...
        dragStop: function(ev, ui) {},
        open: function() {
          return $("#frameDetail").attr("src", sMyself + "Person.Detail?PersonID=" + nPersonID + "&Mini=1");
        },
        close: function() {},
        resizeStop: function(ev, ui) {}
      });
      $(".PersonLink").click(function() {
        var nPersonID, sPersonName;
      ...
      $(".EditCheckinLink").bind("click", this, function() {
        ...
        return $("#CheckinEdit" + nPersonID).show();
      });
      $(".AttendeeStatusID").change(function() {
        var $Attendee, $Type;

        $Attendee = $.ListGetAt(this.id, 2, "-");
        $Type = $(this).val();
        return updateStatusDate($Attendee, $Type);
      });
      $(".EditStatusDate").bind("click", this, function() {
        var CurrID, dtCurrDate, nAttendee, nHour, sDate, sTime;

        CurrID = this.id;
        nAttendee = $.ListGetAt(this.id, 2, "-");
        ...
        return $("#editdatecontainer-" + nAttendee).show();
      });
      $(".EditDateField").keydown(function() {
        var dtStatusMask;

        if ($.Len($(this).val()) > 0) {
          return dtStatusMask = $(this).val();
        }
      });
      $(".SaveDateEdit").bind("click", this, function() {
        var CurrID, dtDate, nAttendee, nType;
        ...
        if (nType !== "" && $.Len(dtDate) > 0) {
          return $.post(sRootPath + "/_com/AJAX_Activity.cfc", {
            ...
            var Status, cleanData, statusMsg;
    ...
    _init = function() {
      var $addlAttendeesMenu, $base, setCheckedStatuses, statusText;
      ...
      setCheckedStatuses = function(nStatus) {
        ...
        $.blockUI({
          message: "<h1>Updating information...</h1>"
        });
        result = "";
        cleanData = "";
        ...
        $.ajax({
          ...
          success: function(returnData) {
            ...
            if (status) {
              ...
              return updateRegistrants(nId, nStatus);
            } else {
              addError(statusMsg, 250, 6000, 4000);
              return $.unblockUI();
            }
      ...
      */
      ...
      $(".attendees-filter li").live("click", function() {
        ...
        return $.post(sRootPath + "/_com/UserSettings.cfc", {
          ...
          return updateRegistrants(1, nStatus);
        });
      });
      ...
      $("#RemoveChecked").bind("click", function() {
        ...
        if (confirm("Are you sure you want to remove the checked attendees from this activity?")) {
          cleanData = "";
          $.blockUI({
            message: "<h1>Removing Selected Attendees...</h1>"
          });
          $.ajax({
            url: sRootPath + "/_com/AJAX_Activity.cfc",
            type: "post",
      ...
      $("#RemoveAll").bind("click", function() {
        ...
        if (confirm("WARNING!\nYou are about to remove ALL attendees from this Activity!\nAre you sure you wish to continue?")) {
          cleanData = "";
          $.blockUI({
            message: "<h1>Removing All Attendees...</h1>"
          });
          return $.ajax({
            url: sRootPath + "/_com/AJAX_Activity.cfc",
            type: "post",
    ...
    return Self.selectedAttendees = getSelectedAttendees;
  });
...
(function() {
  App.module("Activity.Stats", function(Self, App, Backbone, Marionette, $) {
    ...
    return _init = function() {
      ...
      $refreshLink = $("<a></a>").addClass('btn stats-refresher js-stats-refresher').html($icon);
      refresh(function() {});
    };
  });
...
(function() {
  (function($) {
    ...
    $.uiTypeahead = function(input, settings) {
      ...
      }).width(origWidth).blur(function() {}).keydown(function(event) {
      ...
      $typeahead = $("<div/>").addClass("uiTypeahead").addClass(settings.typeaheadClass).width(origWidth);
...
(function() {
  var announcer, crashCart, defibrillate, defibrillator, delay, startDefibrillator, stopDefibrillator;
